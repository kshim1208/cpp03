...
ClapTrap::ClapTrap(unsigned int hit_points, unsigned int energy_points, unsigned int attack_damage)
{
	this->name_ = "ClapTrap";
...
ClapTrap::ClapTrap(const ClapTrap& source)
{
	...
	std::cout << "Clap - " << this->name_ << " has been copy-created !!!" << std::endl;
}
...
ClapTrap& ClapTrap::operator=(const ClapTrap& source)
{
	...
	this->energy_points_ = source.energy_points_;
	this->attack_damage_ = source.attack_damage_;
	std::cout << "Clap - " << this->name_ << " has been copy-operator-created !!!" << std::endl;
	return (*this);
}
